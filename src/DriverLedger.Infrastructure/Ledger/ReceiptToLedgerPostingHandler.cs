    ...
    ILogger<ReceiptToLedgerPostingHandler> logger)
    {
        ...
        public async Task HandleAsync(MessageEnvelope<ReceiptExtractedV1> envelope, CancellationToken ct)
        {
            ...
            try
            {
                ...
                // Choose amounts
                // M1: Amount = Total (incl tax). GstHst = Tax (ITC candidate).
                var amount = norm.Total ?? 0m;
                var gstHst = norm.Tax ?? 0m;
                ...
                line.SourceLinks.Add(new LedgerSourceLink
                {
                    TenantId = tenantId,
                    LedgerLineId = line.Id, // generated by Entity
                    ReceiptId = payload.ReceiptId,
                ...
                db.Notifications.Add(new Notification
                {
                    ...
                    Body = $"Posted {amount:0.00} (tax {gstHst:0.00}) from receipt.",
