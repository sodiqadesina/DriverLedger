...
namespace DriverLedger.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251228001302_FixConfidenceAndSourceLinkIndexes")]
    partial class FixConfidenceAndSourceLinkIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DriverLedger.Domain.Ledger.LedgerSourceLink", b =>
                {
                    ...
                    b.HasIndex("LedgerLineId", "ReceiptId", "FileObjectId")
                        .IsUnique()
                        .HasFilter("[ReceiptId] IS NOT NULL AND [FileObjectId] IS NOT NULL");

                    b.HasIndex("LedgerLineId", "StatementLineId", "FileObjectId")
                        .IsUnique()
                        .HasFilter("[StatementLineId] IS NOT NULL AND [FileObjectId] IS NOT NULL");
